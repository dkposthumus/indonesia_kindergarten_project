/*
capture log close
log using 04_labor_force_participation, replace text
*/

/*
  program:    	04_labor_force_participation.do
...
local tag 07_labor_force_participation.do
...
keep hhid14_9 hhid14 pidlink pid14 labor_force unemployed_6 unemployed_3
