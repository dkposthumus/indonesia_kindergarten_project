/*
capture log close
log using 02_parental_char, replace text
*/

/*
  program:    	02_parental_char.do
  task:			To clean and create a dataset of parental characteristics, in 
				IFLS 2. 
...
/*
	...
	We are interested in the following parental characteristics: 
...
/*
	...
	hh can assume the following values:
		- 0: "0_no"
			- ar02b != 1 ("01. Head")
		- 1: "1_yes"
			- ar02b = 1 ("01. Head")
...
label var evschl_hh "Has the head of your household ever gone to school/is currently going to school?"
label var educ_level_hh "Highest level of education attended by your head of household"
label var educ_hh "Years of education for head of household"

********************************************************************************Finish Up ********************************************************************************

local tag 02_parental_char.do
...
cd "$clean/ifls2_hh"
save ifls2_parental_char, replace
